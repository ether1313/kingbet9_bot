...
1. **GET FREE SPIN ON KINGBET9 🎰** - Shows free spin promotional information with inline buttons:
...
- `TELEGRAM_CHANNEL` (Optional) - Telegram channel URL (default: `https://t.me/kingbet9`)
- `FREE_SPIN_URL` (Optional) - Free spin promotion URL (default: `https://kingbet9.com/RFIKINGBET9BOT9`)
- `FREE_CREDIT_URL` (Optional) - Free credit promotion URL (default: `https://kingbet9.com/RFIKINGBET9BOT9`)
...
```bash
docker build -t kingbet9-bot .
docker run -d --env-file .env kingbet9-bot
```
...
2. Create volume: `fly volumes create kingbet9_bot_data --size 1 --region sin`
...
**Kingbet9 Promo Bot** - Making marketing simpler! 🚀
